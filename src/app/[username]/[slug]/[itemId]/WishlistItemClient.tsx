...
const WishlistItemClient = ({ initialData }: { initialData: any }) => {
  ...
  const [item, setItem] = useState<any>(initialData?.item || null);
  const [wishlist, setWishlist] = useState<any>(initialData?.wishlist || null);
  ...
  }, [username, slug, itemId, router, initialData]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* All the modals remain the same - Buy Modal, Cash Modal, etc. */}
        {/* Buy Modal */}
...
export default WishlistItemClient;
