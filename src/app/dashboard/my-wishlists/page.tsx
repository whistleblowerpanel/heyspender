            ...
            <div className="flex flex-col sm:flex-row gap-4 flex-1">
              ...
              <div className="relative flex-1 max-w-md">
                <input
                  ...
                  className="w-full px-4 py-2 border-2 border-black bg-white text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-purple-dark"
                />
                {searchQuery && (
                  <button
              ...
              <select
                ...
                className="px-4 py-2 border-2 border-black bg-white text-black focus:outline-none focus:ring-2 focus:ring-brand-purple-dark"
              >
            ...
            <div className="flex items-center gap-4">
              {filteredWishlists.length > 0 && (
                <label className="flex items-center gap-2 text-sm text-gray-600 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={selectedWishlists.length === filteredWishlists.length && filteredWishlists.length > 0}
                    onChange={(e) => {
                      if (e.target.checked) {
        ...
        <div className="mb-6">
          <div className="flex flex-wrap gap-3 items-center">
            <Button
              ...
              variant="custom"
              className="bg-brand-green text-black border-2 border-black"
            >
            ...
            <Button
              ...
              variant="custom"
              className="bg-brand-orange text-black border-2 border-black"
            >
            ...
            <Button
              ...
              variant="custom"
              className="bg-brand-purple-dark text-white border-2 border-black"
            >
            ...
            {selectedWishlists.length > 0 && (
              <div className="flex items-center gap-2 ml-auto">
                <span className="text-sm text-gray-600">
                  {selectedWishlists.length} selected
                </span>
                <Button
                  variant="outline"
                  size="sm"
                ...
                <div className="space-y-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white border-2 border-black p-6">
                      <h3 className="text-lg font-semibold text-brand-purple-dark mb-2">Recent Activity</h3>
                      <div className="space-y-2">
                        {wishlists.slice(0, 3).map((wishlist) => (
                          <div key={wishlist.id} className="flex items-center justify-between text-sm">
                            <span className="text-gray-600 truncate">{wishlist.title}</span>
                    ...
                    <div className="bg-white border-2 border-black p-6">
                      <h3 className="text-lg font-semibold text-brand-purple-dark mb-2">Quick Stats</h3>
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Cash Goals:</span>
                          <span className="font-medium">{cashGoals.length}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Live Wishlists:</span>
                          <span className="font-medium">{wishlists.filter(w => w.status === 'live').length}</span>
                        </div>
                      </div>
                    </div>

                    <div className="bg-white border-2 border-black p-6">
                      <h3 className="text-lg font-semibold text-brand-purple-dark mb-2">Quick Actions</h3>
                      <div className="space-y-2">
                        <Button
                          onClick={handleCreateWishlist}
                          variant="outline"
