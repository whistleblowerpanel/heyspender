      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center space-y-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug md:leading-normal">
            <span className="text-white">Welcome{userName ? `, HeyWisher ${userName}` : ', HeyWisher'}</span>
            <br />
            <span className="text-white">Let's Build Your Wishlist</span>
          </h1>

          <p className="text-lg sm:text-xl text-white/90 max-w-2xl mx-auto">
            Organize occasions, add wishlist items or cash goals, and share with your HeySpenders.
          </p>
        </div>
      </div>
    </section>
